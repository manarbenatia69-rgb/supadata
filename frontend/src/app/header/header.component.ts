...
export class HeaderComponent {
  IsEntrepriseIn:boolean
  IsEmployerIn:boolean
  IsParticulierIn:boolean
  ...
  ngOnInit(): void {
    this.IsEntrepriseIn=this.service.isEntrepriseIn();
    this.IsEmployerIn=this.service.isEmployerIn();
    this.IsParticulierIn=this.service.isParticulierIn();
  }
