...
@Component({
  ...
  styleUrls: ['./login-employer.component.css', '../shared/login-shared.css']
})
export class LoginEmployerComponent {
 ...
 isLocked = false;
  ...
  login() {
    ...
    let employer = new Employer(null, null, null,null,null,null,null,null,null,data.email, data.pwd, null,null,null,null,null,null,null,null);
console.log(data)
console.log(employer)
    this.service.loginEmployer(employer).subscribe({
      next: (res) => {
        let token = res.token;
        localStorage.setItem("myTokenEmployer", token);
 ...
 ngOnInit() {
    ...
    script.onload = () => {
      ...
      google.accounts.id.initialize({
        client_id:'710278742537-ona619q0ujhh2bnlvf7g4ik5jp3482lm.apps.googleusercontent.com',
