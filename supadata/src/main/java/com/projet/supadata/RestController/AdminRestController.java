...
public class AdminRestController {
    ...
    ResponseEntity<?> AjouterAdmin (@RequestBody Admin admin){
        ...
        if(adminRepository.existsByEmail(admin.getEmail())){
            ...
            admin.setPwd(this.bCryptPasswordEncoder.encode(admin.getPwd()));
    ...
    public Admin ModifierAdmin(@PathVariable("id")Long id, @RequestBody Admin admin){
        ...
        Admin newAdmin = adminService.Modifier(admin);
        return newAdmin;
    }
    @PostMapping("/login")
    public ResponseEntity<Map<String, Object>> loginAdmin(@RequestBody Admin admin) {
        ...
        if (userFromDB == null) {
            ...
            boolean compare = this.bCryptPasswordEncoder.matches(admin.getPwd(), userFromDB.getPwd());
